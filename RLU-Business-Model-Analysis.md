...
- **Seat-filling source, confirmed Aug 21: the 1,058 engaged email subscribers** (opened or clicked at least once). Fifteen seats needs 1.4% of this pool. Funnel math: 10–25% register for the masterclasses (~110–260), ~13–20% show live plus replay viewers (40–90 in the room), hand-raisers feed the closing-week DMs → honest projection **8–15 seats**, cap reachable at the upper band. Klaviyo cadence, scheduled before the cruise: warm-up ~Sept 29, cart-open Oct 6, masterclass invites Oct 7 and Oct 21, day-of and replay sends, two pre-written cruise sends (Oct 14, Oct 18), honest-seat-count Oct 23, closes-tomorrow Oct 26, two close-day sends Oct 27. Real seat counts only, never invented scarcity. Caveat on record: this list produced zero enrollments at $2,997 during LMC26; the difference is the $497/$997 rung, not the list.
